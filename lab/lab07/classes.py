...
class TutorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        # discard the first 3 cards in the opponent's hand.
        for i in range(3):
            opponent.hand.pop(i)
            # have them draw 3 cards from their deck.
...
class InstructorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        "*** YOUR CODE HERE ***"
        # Adds the attack and defense of the opponent's card to 
         # all cards in the player's deck You should add your implementation above this.
        for card in player.deck.cards:
            card.attack += opponent_card.attack
            card.defense += opponent_card.defense
        #removes all cards in the opponent's deck that share an attack or defense stat with the opponent's card.
